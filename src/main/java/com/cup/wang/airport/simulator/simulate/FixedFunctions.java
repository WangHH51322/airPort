...
//                }
                ...
                DenseVector Bold = new DenseVector(B);
                DenseVector Xnew = new DenseVector(X);

                SparseVector Bnew = new SparseVector(Bold);
//                SparseVector Xnew = new SparseVector(Xold);
...
//                BiCGstab biCGstab = new BiCGstab(Bnew);
...
//            }
            ...
            int panduan3 = 0;
            for (int i = 0; i < Qn[0].length; i++) {
                if (Math.abs(Qn[mm + 1][i] - Qn[mm][i]) > 0.000001){
                    panduan3 = 1;
                }
            }
            for (int i = 0; i < Hn[0].length; i++) {
